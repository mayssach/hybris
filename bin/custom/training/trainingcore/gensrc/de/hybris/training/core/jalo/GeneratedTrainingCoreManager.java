...
public abstract class GeneratedTrainingCoreManager extends Extension
{
	...
	static
	{
		...
		tmp.put("codePostal", AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.codePostal</code> attribute.
	 * @return the codePostal
	 */
	public String getCodePostal(final SessionContext ctx, final Customer item)
	{
		return (String)item.getProperty( ctx, TrainingCoreConstants.Attributes.Customer.CODEPOSTAL);
	}
	 ...
	 * @return the codePostal
	 */
	public String getCodePostal(final Customer item)
	{
		return getCodePostal( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Customer.codePostal</code> attribute. 
	 * @param value the codePostal
	 */
	public void setCodePostal(final SessionContext ctx, final Customer item, final String value)
	{
		item.setProperty(ctx, TrainingCoreConstants.Attributes.Customer.CODEPOSTAL,value);
	}
	 ...
	 * @param value the codePostal
	 */
	public void setCodePostal(final Customer item, final String value)
	{
		setCodePostal( getSession().getSessionContext(), item, value );
	}
