 ...
 */
package de.hybris.training.services.service.impl;
 ...
 */
@IntegrationTest
public class DefaultTrainingservicesServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "trainingservicesPlatformLogo";

		// when
		final String logoUrl = trainingservicesService.getHybrisLogoUrl(logoCode);
