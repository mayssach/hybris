...
public class DefaultTrainingservicesService implements TrainingservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingservicesService.class);
	...
	{
		return DefaultTrainingservicesService.class.getResourceAsStream("/trainingservices/sap-hybris-platform.png");
	}
