        ...
        <li class="item__list--item">
            ...
            <div class="item__info">
                ...
                <div class="item__stock">
                    ...
                    <div>
                        <c:choose>
                            <c:when test="${not empty entryStock and not empty entry.product.stock.stockLevel and entryStock ne 'outOfStock' or entry.product.multidimensional}">
                                <!--******** -->    <span>${entry.product.stock.stockLevel}</span>
