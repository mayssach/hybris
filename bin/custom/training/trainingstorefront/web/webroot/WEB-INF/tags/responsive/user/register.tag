...
<form:form method="post" modelAttribute="registerForm1" action="${action}">
	...
	<formElement:formInputBox idKey="register.email"
		...
		mandatory="true" />
	<formElement:formInputBox idKey="register.codePostal"
	    labelKey="register.codePostal" path="codePostal" inputCSS="form-control"
	    mandatory="true" />
