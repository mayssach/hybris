...
import de.hybris.training.storefront.forms.validation.ProfileValidator1;
...
public class AccountPageController extends AbstractSearchPageController
{
	...
	@Resource(name = "profileValidator1")
	private ProfileValidator1 profileValidator;
	...
	protected ProfileValidator1 getProfileValidator()
	{
	...
	protected void setCustomerFacade(CustomerFacade customerFacade) {
	...
	public String editProfile(final Model model) throws CMSItemNotFoundException
	{
		...
		final CustomerData customerData = customerFacade.getCurrentCustomer();
		final UpdateProfileForm1 updateProfileForm = new UpdateProfileForm1();
		...
		updateProfileForm.setCodePostal(customerData.getCodePostal());
	...
	@RequireHardLogIn
	public String updateProfile(final UpdateProfileForm1 updateProfileForm, final BindingResult bindingResult, final Model model,
								final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		customerData.setCodePostal(updateProfileForm.getCodePostal());
