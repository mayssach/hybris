...
public class DefaultReviewsservicesService implements ReviewsservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultReviewsservicesService.class);
	...
	{
		return DefaultReviewsservicesService.class.getResourceAsStream("/reviewsservices/sap-hybris-platform.png");
	}
