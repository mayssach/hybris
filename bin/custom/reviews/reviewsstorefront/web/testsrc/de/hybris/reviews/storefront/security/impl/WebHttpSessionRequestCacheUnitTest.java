...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/reviewsstorefront/electronics/en",
						"https://electronics.local:9002/reviewsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/reviewsstorefront/electronics/en",
						"https://electronics.local:9002/reviewsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/reviewsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/reviewsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/reviewsstorefront/electronics/en",
						"https://electronics.local:9002/reviewsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/reviewsstorefront",
						"https://electronics.local:9002/reviewsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/reviewsstorefront",
						"https://electronics.local:9002/reviewsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/reviewsstorefront/electronics/en",
						"https://electronics.local:9002/reviewsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
