...
public class ProductPageController extends AbstractPageController
{
			...
			throws CMSItemNotFoundException, UnsupportedEncodingException
	{
		...
		final List<ReviewData> reviews=productFacade.getReviews(productCode,null);
		...
		if (haveProductInOrder) {
			...
			model.addAttribute("verif", false);
		}
	...
	public String postReview(@PathVariable("productCode") final String encodedProductCode, final ReviewForm form,
			...
			throws CMSItemNotFoundException, EmailException, MessagingException {
